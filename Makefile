...
deploy-rinkeby :; @forge create src/${contract}.sol:${contract} --constructor-args "Test" "TST" "" --rpc-url ${RINKEBY_RPC_URL} --private-key ${PRIVATE_KEY} --verify --etherscan-api-key ${ETHERSCAN_KEY}
